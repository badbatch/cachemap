...
*Defined in [types.ts:8](https://github.com/badbatch/cachemap/blob/27e229b/packages/map/src/types.ts#L8)*
...
*Defined in [types.ts:4](https://github.com/badbatch/cachemap/blob/27e229b/packages/map/src/types.ts#L4)*
