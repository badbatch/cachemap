...
*Defined in [types.ts:4](https://github.com/badbatch/cachemap/blob/ba019ba/packages/indexed-db/src/types.ts#L4)*
...
*Defined in [types.ts:8](https://github.com/badbatch/cachemap/blob/ba019ba/packages/indexed-db/src/types.ts#L8)*
